...
static_assert(foo() == 2, "CHOOSE_MACRO_VA_ARG() result does not match for 0 arguments");
static_assert(foo(arg1) == 1, "CHOOSE_MACRO_VA_ARG() result does not match for 1 argument");
#if defined(__cplusplus) && (__cplusplus >  201703L)
    static_assert(foo(arg1, arg2) == 1, "CHOOSE_MACRO_VA_ARG() result does not match for n arguments");
#endif
