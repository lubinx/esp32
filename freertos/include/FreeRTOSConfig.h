...
#else
    #define configNUM_CORES             SOC_CPU_CORES_NUM
#endif
...
#define configUSE_MINIMAL_IDLE_HOOK     0   // disable this since nobody use that
...
#define configINCLUDE_FREERTOS_TASK_C_ADDITIONS_H   1   // include freertos_tasks_c_additions.h __getreent() function has to compile with task.c

// ----------------------- Memory  -------------------------

#define configSUPPORT_STATIC_ALLOCATION     1
#define configSUPPORT_DYNAMIC_ALLOCATION    0           // REVIEW: disabled all dynamic allocation
