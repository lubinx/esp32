...
#define CACHE_BUS_IBUS0                 (1 << 0)
#define CACHE_BUS_IBUS1                 (1 << 1)
#define CACHE_BUS_IBUS2                 (1 << 2)
#define CACHE_BUS_DBUS0                 (1 << 3)
#define CACHE_BUS_DBUS1                 (1 << 4)
#define CACHE_BUS_DBUS2                 (1 << 5)
...
static inline void cache_ll_l1_disable_bus(uint32_t cache_id, unsigned mask)
{
    ...
    assert((mask & (CACHE_BUS_IBUS1 | CACHE_BUS_IBUS2| CACHE_BUS_DBUS1 | CACHE_BUS_DBUS2)) == 0);
