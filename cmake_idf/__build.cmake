...
function(__build_expand_requirements component_target)
    ...
    foreach(req ${reqs})
        __build_resolve_and_add_req(_component_target ${component_target} ${req} REQUIRES)
        __build_expand_requirements(${_component_target})
    endforeach()

    foreach(req ${priv_reqs})
        __build_resolve_and_add_req(_component_target ${component_target} ${req} PRIV_REQUIRES)
        __build_expand_requirements(${_component_target})
    endforeach()
endfunction()
