...
static inline
    ...
    {
        dev->unit_load_val[counter_id].hi.timer_unit_load_hi = BIT_WIDTH_OF(20, value >> 32);
...
static inline
    ...
    {
        dev->target_val[alarm_id].hi.timer_target_hi = BIT_WIDTH_OF(20, value >> 32);
...
static inline
    ...
    {
        dev->target_conf[alarm_id].target_timer_unit_sel = BIT_WIDTH_OF(1, counter_id);
    }
...
static inline
    ...
    {
        dev->target_conf[alarm_id].target_period = BIT_WIDTH_OF(26, period);
    }
